...
/**
 * This class listens for an action and when triggered, switches from the options page to the payment page.
 */
public class GoToPaymentPage implements ActionListener {
    @Override
    public void actionPerformed(ActionEvent e) {
        ...
        cardLayout.show(optionsPanel, "Payment Page");
    }   
}
